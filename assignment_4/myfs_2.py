...
def myinfo(drive):
	...
	result=[]
	string=str(superblock[1])+" "+str(superblock[2])+'B'
	result.append(string)
	result.append(superblock[-1])
...
def drive_info(drive):
	...
	[drive_size, number_of_files, occupied, free]=myinfo(drive)
	
	print()	
	print("Drive Name : ",drive)
	print("Drive size : ",drive_size)
	print("Number of files : ",number_of_files)
	print("Occupied : ",occupied)
	print("Free space available : ",free)
	print()		
